...
\begin{document}
    ...
    \begin{proof}[Solution]
        ...
        \begin{enumerate}
            ...
            \item \curlyquotes{$\mathcal G$ contains $K_4$ as subgraph}, which is represented by the following sentence of rank 4 $$\exists x_1 \exists x_2 \exists x_3 \exists x_4 \quad \rbk{\bigwedge_{\substack{1 \le i, j \le 4 \\ i \neq j}}{\lnot (x_i = x_j)}} \land \rbk{\bigwedge_{\substack{1 \le i, j \le 4 \\ i \neq j}}{E(x_i, x_j)}}$$
        \end{enumerate}
        ...
        \claim{
            ...
            Thus, the Duplicator has a strategy to always win at least 2 rounds, therefore the Duplicator wins $G_2(\mathcal G_1, \mathcal G_2)$ by the Ehrenfeucht theorem.
        }
